...
public interface CieRepositorio extends JpaRepository<CIE10, Long> {
    ...
    @Query(value = "select admc.CVE_CODIGO , admc.ID_DIAGNOSTICO_MEDICO_CIE10  , admc.NOM_DIAGNOSTICO_MEDICO_CIE10  from adtsc_diagnostico_medico_cie10 admc where admc.NOM_DIAGNOSTICO_MEDICO_CIE10 like ?1% and admc.IND_ACTIVO =1",nativeQuery = true)
    List<CIE10> autoCompleteCie(String caracteres);
}
